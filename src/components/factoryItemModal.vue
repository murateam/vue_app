<template>
    <b-modal
        ...
        @hidden="resetModal"
    >
        <b-container fluid><h5>Factory Item</h5>
            <div v-if="typeFactoryItem == 'factory'"><h5>Factory</h5>
            </div>
            <div v-if="typeFactoryItem == 'collection'"><h5>Collection</h5>
            </div>
            <div v-if="typeFactoryItem == 'catalogue-number'"><h5>Catalogue number</h5>
            </div>
